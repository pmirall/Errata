...
// here does not breach the BRIEF section 4 rule, which governs game time.
...
// =============================================================================
//  4. MANDATORY PUBLIC INTERFACE (BRIEF section 4, row 20)
// =============================================================================
...
// eleven columns are exactly the GAME_DESIGN 10.2 format
...
// GAME_DESIGN 10.2: above x1 the sleep window is frozen at the local hour
