...
//  arguments, so the same Pebble glitches the same way on every device.
//
//  Identifiers and comments: English. This module draws no glyphs and needs no
//  strings_es.h.
// =============================================================================
#ifndef PB_UI_CORRUPT_FX_H
#define PB_UI_CORRUPT_FX_H
