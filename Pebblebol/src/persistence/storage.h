// =============================================================================
//  NOTTAMAGOCHI - persistence/storage.h
...
//
// The anti-farm ceiling (config.h section 12) is a per-stat budget of
...
// The layering seam. store_save() calls this provider at the instant it commits a "save"
...
// -----------------------------------------------------------------------------
// ADDITIONS beyond the core interface above (additive; nothing above changes).
