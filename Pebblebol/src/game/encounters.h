...
//  that the player sees the same wild Pebble again rather than a fresh roll.
//
// -----------------------------------------------------------------------------
...
//    SPEV_CORRUPTION  sets PBS_CORRUPTED on the active Pebble for 24 h
...
// =============================================================================
#ifndef PB_GAME_ENCOUNTERS_H
#define PB_GAME_ENCOUNTERS_H
...
// How far either side of the active Pebble's level a wild one may be found.
