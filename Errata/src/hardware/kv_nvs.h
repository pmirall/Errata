...
//
//  NAMESPACE "pbbl" (decision D3). The v1 firmware used "notta"; a Errata
...
// "pbbl" is the namespace every device in the field already opens. It is not
// the product's name any more and it is not supposed to be - see BUG_MAGIC in
// persistence/save_schema.h for the whole argument.
#define ER_NVS_NAMESPACE    "pbbl"     // D3, the pre-rename namespace
#define ER_NVS_LEGACY_NS    "notta"    // v1, read once and cleared
#define ER_NVS_CKPT_PART    "nvs2"     // D6
