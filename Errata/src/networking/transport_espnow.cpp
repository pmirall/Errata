// =============================================================================
//  ERRATA - networking/transport_espnow.cpp
...
// ER_LINK_CHANNEL IS CHECKED HERE AND NOT WHERE IT IS SET, because this is the
...
static_assert(ER_LINK_CHANNEL >= 1 && ER_LINK_CHANNEL <= 11,
              "ER_LINK_CHANNEL must be inside the world-safe country range "
