// =============================================================================
//  net.h - Errata radio state machine.
//
...
enum NetPhase : uint8_t {
  ...
  NPH_LINK,             // WIFI_STA on ER_LINK_CHANNEL with ESP-NOW up. NEVER
...
// "ERRATA-XXXX", derived from the STA MAC. Never NULL. (The prefix was
...
// drives: bring WIFI_STA up on ER_LINK_CHANNEL with ESP-NOW resident, put one
