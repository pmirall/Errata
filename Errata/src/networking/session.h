...
// =============================================================================
#ifndef ER_NETWORKING_SESSION_H
#define ER_NETWORKING_SESSION_H
...
// mismatch is named (SD_OP) at the last moment before a Bug is on the wire
...
enum SessionDetail : uint8_t {
  ...
  SD_TRADE_REFUSED,    // the peer's TradeReject on our offer: a legal Bug it
...
struct Session {
  ...
  uint8_t  my_rec[BATTLE_TEAM_MAX][BUGW_BYTES];
  uint8_t  my_count;
...
// FREEZES THE ONE BUG THIS DEVICE IS OFFERING IN A TRADE. The trade twin of
