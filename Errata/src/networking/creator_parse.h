// =============================================================================
//  ERRATA - networking/creator_parse.h
...
//  ==========================================================================
//  1. THE UPLOAD, for POST /api/validate and POST /api/bug:
//
...
//     species of a Bug already in the Box. The DEVICE picks the slot and
...
// =============================================================================
#ifndef ER_CREATOR_PARSE_H
#define ER_CREATOR_PARSE_H
