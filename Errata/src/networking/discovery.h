...
// =============================================================================
#ifndef ER_NETWORKING_DISCOVERY_H
#define ER_NETWORKING_DISCOVERY_H
...
// stranger is not a Errata in the room.
uint8_t link_qualified_count(const LinkJob& j);

#endif  // ER_NETWORKING_DISCOVERY_H
