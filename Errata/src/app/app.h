// =============================================================================
//  ERRATA - app/app.h
//  The two entry points the Arduino runtime calls. Errata.ino is a three
...
// Bug, metered by the anti-farm ledger of game/xp.h, and owns everything a
...
// Bug levelled. Called by ui.cpp for care actions and minigames and by the
...
// slot, see game/activity.h - and happiness onto the ACTIVE Bug, clamped
...
// -----------------------------------------------------------------------------
// Should the player be asked? True when the active Bug carries
...
// Bug has reached flash before this returns, so the caller may start the
