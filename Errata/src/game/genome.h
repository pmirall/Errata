...
//
//  LAYERING: this module includes NO Arduino, WiFi, BLE, WebServer or
...
// -----------------------------------------------------------------------------
// 5. GENE ACCESSORS - raw values, exactly as stored
// -----------------------------------------------------------------------------
...
//
//    Base formula: mult = 600 + v*60  (config.h
//    GENE_MULT_BASE / GENE_MULT_STEP), i.e. 0.60 + v*0.06.
//
//    rare_flag ("+1 to all _mult favourably") is applied here
