...
// =============================================================================
#ifndef ER_EVOLUTION_H
#define ER_EVOLUTION_H
...
// -----------------------------------------------------------------------------
//  BugInstance.evo_state (offset 27, pinned by the save schema)
//
...
uint8_t evolution_level_ready(const BugInstance& p);
...
uint8_t evolution_ready(const BugInstance& p, const EvoContext& ctx);
...
// wrong must not be able to mutate the Bug.
//
...
bool evolution_apply(BugInstance& p, const EvoContext& ctx);

#endif  // ER_EVOLUTION_H
