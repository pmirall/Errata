...
//  A Bug at XP_LEVEL_MAX used to earn NO activity happiness, because
...
//  rather than XP that found a home, so a maxed Bug drains a source's daily
...
// =============================================================================
#ifndef ER_GAME_ACTIVITY_H
#define ER_GAME_ACTIVITY_H
...
//               milli = 5.5 % of the happiness bar (ER_CARE_MILLI_MAX 100000):
...
// awake_s seconds of the active Bug being carried AWAKE. Whole minutes are
...
// paid 125,000 care milli-points against a bar (ER_CARE_MILLI_MAX) of 100,000.
