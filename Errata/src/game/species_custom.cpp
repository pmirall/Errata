// =============================================================================
//  ERRATA - game/species_custom.cpp
...
bool csp_install(const CustomSpeciesRec& rec)
{
  ...
  // the slot EMPTY, so species_get() keeps answering nullptr and the Bug
  ...
  // the device put species 1's body on their Bug. The pixels are KEPT below
  ...
  // The name lives on the BugInstance's nickname, not in a StrId: there is
