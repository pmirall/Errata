...
#include "../persistence/save_schema.h"   // ER_MOVE_COUNT, ER_LEVEL_MAX

// BugType (spec section 12). The chart is three-cornered and TYPE_COUNT is
