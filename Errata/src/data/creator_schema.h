...
// Spec section 36: a custom Bug is capped at the STAGE-1 budget so it can
...
// `<=`; the note below requires a custom Bug to be never WEAKER than a
...
#define CREATOR_MOVE_COUNT         ER_MOVE_COUNT
#define CREATOR_BASE_STAT_MIN      1
#define CREATOR_BASE_STAT_MAX      10

// The built-in budgets a custom Bug is measured against, by stage.
...
// A custom Bug may never be stronger than a stage-1 built-in, and never
