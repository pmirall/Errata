...
//  Errata in the room, the consent that turns "found" into "agreed", and the
...
//      LKM_CARD     "¡ERRATA ENCONTRADA!" and section 42's four rows:
...
// =============================================================================
#ifndef ER_SCREEN_LINK_H
#define ER_SCREEN_LINK_H
...
//  the two Bugs and an "A: aceptar" affordance the moment both sides have
