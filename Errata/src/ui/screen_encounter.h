...
//    WILD     "!BUG SALVAJE!" with the species and level, and the two
...
//    * the active Bug is never touched, which game/box.h's invariant B4
//      makes structural rather than a rule this screen has to remember.
//
//  PURE translation unit.
// =============================================================================
#ifndef ER_SCREEN_ENCOUNTER_H
#define ER_SCREEN_ENCOUNTER_H
