...
//  app_award_xp(), which writes the ACTIVE Bug's level, xp and hp_cur and
...
// =============================================================================
#ifndef ER_SCREEN_BATTLE_H
#define ER_SCREEN_BATTLE_H
...
//           caught. ONE Bug a side: the player's ACTIVE one against the one
...
// It repairs THIS DEVICE'S OWN Bug before it is offered; it is not, and must
