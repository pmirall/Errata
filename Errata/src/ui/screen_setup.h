...
//    L held     ACCEPT           (take this name / take this Bug)
...
//  CAL_UNSET, the Bug is the historical starter), so SKIP and FINISH are
...
// =============================================================================
#ifndef ER_SCREEN_SETUP_H
#define ER_SCREEN_SETUP_H
