...
// =============================================================================
#ifndef ER_UI_PETFX_CORE_H
#define ER_UI_PETFX_CORE_H
...
//  data/sprites_bugs.h's own guard refuses a set wider than that.
//
...
//  thing distinguishing one player's Bug from another's. So the pose a
//  player stares at longest was the pose where every Bug looked the same.
//
...
//  art cap (ER_SPRITE_DATA_BYTES_MAX has 1,024 B of headroom, exactly seven
...
//  which case the caller falls back to the authored BUGSPR_SLEEP body.
//
...
// falls under it FAILS THE SUITE BY NAME rather than shipping as a Bug that
